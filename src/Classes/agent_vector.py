...
if __name__ == '__main__':
    ...
    plot_file_path = '/zhome/db/e/206305/snake_ai/src/Classes/DQL_PLOT/TEST_PLOTS/vector_training_17_01.pkl'

    ## Initialisér agent
    agent = Agent(state_rep='vector', render=False, learning_rate=0.0001, epsilon_decay=0.9999997,
                  step_reward=-3, apple_reward=87, reward_closer=2, death_reward=-268,
                  training=True, model_name="vector_17_01")
    ##TRÆN
