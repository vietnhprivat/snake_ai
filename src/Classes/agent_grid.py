...
if __name__ == '__main__':
    ...
    plot_file_path = '/zhome/db/e/206305/snake_ai/src/Classes/DQL_PLOT/TEST_PLOTS/plot_file_grid_15_01.pkl'
    ## Initialisér agent
    agent = Agent(state_rep='grid', apple_reward=68, step_reward=8, death_reward=-112, reward_closer=2, render=False, epsilon_decay=0.9999985,
                  learning_rate=0.0001, model_name="grid_15_01")
